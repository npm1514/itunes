...
app.controller('mainCtrl', function($scope, itunesService) {
  ...
  $scope.createList = function(list) {
    ...
    for (var i = 0; i < list.length; i++) {
      newList.push({
        "AlbumArt": list[i].artworkUrl100,
        "Artist": list[i].artistName,
        "Collection": list[i].collectionName,
        "CollectionPrice": list[i].collectionPrice,
        "Play": list[i].previewUrl,
        "Song": list[i].kind
      });
    }
    console.log(newList);
    $scope.songData = newList;
  };
...
/*
  artworkUrl100    AlbumArt: "http://a3.mzstatic.com/us/r30/Features4/v4/22/be/30/22be305b-d988-4525-453c-7203af1dc5a3/dj.srlprmuo.100x100-75.jpg"
  artistName    Artist: "Nelly"
  collectionName    Collection: "Nellyville"
  collectionPrice    CollectionPrice: 11.99
  previewUrl    Play: "http://a423.phobos.apple.com/us/r1000/013/Music4/v4/4a/ab/7c/4aab7ce2-9a72-aa07-ac6b-2011b86b0042/mzaf_6553745548541009508.plus.aac.p.m4a"
  kind    Type: "song"
  */
